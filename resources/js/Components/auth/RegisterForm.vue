...
<template>
    ...
    <v-form id="form" v-model="valid" lazy-validation  class="mt-5">
        ...
        <VTextField
            ...
            color="primary"
        ></VTextField>
        <v-label class="text-subtitle-1 font-weight-medium pb-2">Confrim Password</v-label>
        <VTextField
            ...
            color="primary"
        ></VTextField>
        <v-btn form="form" size="large" class="mt-2" color="primary" @click="submit" block submit rounded="pill">Sign Up</v-btn>
    </v-form>
</template>
