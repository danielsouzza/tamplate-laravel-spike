...
<template>
    <!---Single Item-->
    <div class="mb-1">
        <v-list-item   :to="item.to" :href="item.to" rounded :active="item?.route ? route().current(item.route) : false"
            ...
            <Link :href="item.to" class="text-decoration-none color-inherit">
